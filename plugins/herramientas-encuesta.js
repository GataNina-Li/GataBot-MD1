...
let a = []
let b = text.split('|')
if (!b[1]) return m.reply(`Escriba el motivo\n*${usedPrefix + command} Motivo |texto1|texto2|texto3....*`)
if (b[12]) return conn.reply(m.chat, `${mg}𝙐𝙎𝙀 𝙀𝙇 𝘾𝙊𝙈𝘼𝙉𝘿𝙊 𝘿𝙀 𝙇𝘼 𝙎𝙄𝙂𝙐𝙄𝙀𝙉𝙏𝙀 𝙁𝙊𝙍𝙈𝘼\n*${usedPrefix + command} texto1|texto2|texto3|texto4....*\n\n𝙐𝙎𝙀 𝙏𝙃𝙀 𝘾𝙊𝙈𝙈𝘼𝙉𝘿 𝘼𝙎 𝙁𝙊𝙇𝙇𝙊𝙒𝙎\n*${usedPrefix + command} text1|text2|text3|text4....*`, fkontak, m)
