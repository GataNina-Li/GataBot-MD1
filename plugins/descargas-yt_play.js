...
let { videoId, title, views, published } = await vid2.result[0]
const url = 'https://www.youtube.com/watch?v=' + videoId
...
const buttonMessage = { caption: capt, footer: '*ᴇɴᴠɪᴀɴᴅᴏ ᴀᴜᴅɪᴏ, ᴀɢᴜᴀʀᴅᴇ ᴜɴ ᴍᴏᴍᴇɴᴛᴏ...*', buttons: buttons, headerType: 4 }
