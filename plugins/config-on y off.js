...
{title: "👑 𝙈𝙊𝘿𝙊 𝘼𝘿𝙈𝙄𝙉 | 𝘼𝘿𝙈𝙄𝙉 𝙈𝙊𝘿𝙀", description: "𝙋𝙀𝙍𝙈𝙄𝙏𝙄𝙍 𝙊 𝙉𝙊 𝙌𝙐𝙀 𝙎𝙊𝙇𝙊 𝙇𝙊𝙎 𝘼𝘿𝙈𝙄𝙉𝙎 𝙐𝙎𝙀𝙉 𝙀𝙇 BOT\𝙣𝘼𝙇𝙇𝙊𝙒 𝙊𝙍 𝙉𝙊𝙏 𝙏𝙃𝘼𝙏 𝙊𝙉𝙇𝙔 𝘼𝘿𝙈𝙄𝙉𝙎 𝘾𝘼𝙉 𝙐𝙎𝙀 𝙏𝙃𝙀 𝘽𝙊𝙏", rowId:  `${usedPrefix + command}modoadmin`},
