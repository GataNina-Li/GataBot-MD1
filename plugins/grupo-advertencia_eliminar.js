...
await conn.sendButton(m.chat,`${user.warn == 1 ? `*@${who.split`@`[0]}*` : `*@${who.split`@`[0]}*`} 𝙎𝙀 𝙇𝙀 𝙌𝙐𝙄𝙏𝙊 𝙐𝙉𝘼 𝘼𝘿𝙑𝙀𝙍𝙏𝙀𝙉𝘾𝙄𝘼 𝙀𝙉 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊!!\n\n𝘼 𝙒𝘼𝙍𝙉𝙄𝙉𝙂 𝙒𝘼𝙎 𝙍𝙀𝙈𝙊𝙑𝙀𝘿 𝙄𝙉 𝙏𝙃𝙄𝙎 𝙂𝙍𝙊𝙐𝙋!!`, `*ADVERTENCIA : WARNING*\n⚠️ *Antes: ${user.warn + 1}/4*\n⚠️ Ahora: ${user.warn}/4*\n\n${wm}`, img, [
...
handler.command = /^(del|delete|eliminar|\-)eliminar|warn(ing)?$/i
handler.group = true
handler.admin = true
