...
conn.sendHydrated(m.chat, estado, wm, picture, 'https://github.com/Subbotsito/GataBot-MD', 'the Lolibot MD', null, null, [
['𝙈𝙚𝙣𝙪́ 𝙘𝙤𝙢𝙥𝙡𝙚𝙩𝙤', '.allmenu'],
['𝙑𝙚𝙡𝙤𝙘𝙞𝙙𝙖𝙙', '/ping'],
['𝙑𝙤𝙡𝙫𝙚𝙧 𝙖𝙡 𝙈𝙚𝙣𝙪́', '#menu']
], m,)}

/*conn.sendHydrated(m.chat, estado, wm, picture, 'https://github.com/Subbotsito/GataBot-MD', 'the Lolibot-𝙈𝘿', null, null, [
['𝙑𝙤𝙡𝙫𝙚𝙧 𝙖𝙡 𝙈𝙚𝙣𝙪́', '#menu']
], m)}*/

handler.help = ['estado']
handler.tags = ['main']
handler.command = /^(estado|status|estate|state|heyloli|stado|stats|botstat(us)?)$/i
