...
if (user.joincount.length > 1) throw `${fg}*MÍNIMO 1 TOKEN! 🪙 PARA PODER INVITAR A GATABOT AL GRUPO*`
if (user.joincount.length < 20) throw `${fg}*MÁXIMO 20 TOKEN! 🪙 PARA PODER INVITAR A GATABOT AL GRUPO*`
