...
${user.ayam == 2 || user.coal == 1 || user.ramuan == 1 ? '*👩‍🍳 PUEDE COCINAR 🧑‍🍳*' : ''.concat(`${user.ayam !== 2 ? `❗${rpgg.emoticon('ayam')} ` : ''}`, `${user.coal !== 1 ? `❗${rpgg.emoticon('coal')} ` : ''}`, `${user.ramuan !== 1 ? `❗${rpgg.emoticon('ramuan')}` : ''}`)} 
- - - - - - - - - - - - -
▧ ayamgoreng 🍗
