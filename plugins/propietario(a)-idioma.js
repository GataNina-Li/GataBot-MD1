...
let idioma = await translate(`${texto}`, { to: String(global.lenguajeGB), autoCorrect: true })
let idioma2 = await translate(`${texto2}`, { to: String(global.lenguajeGB), autoCorrect: true })
let idioma3 = await translate(`${texto3}`, { to: String(global.lenguajeGB), autoCorrect: true })
