...
let idioma = await translate(`${texto}`, { to: 'es', autoCorrect: true })
let idioma2 = await translate(`${texto2}`, { to: 'es', autoCorrect: true })
let idioma3 = await translate(`${texto3}`, { to: 'es', autoCorrect: true })
