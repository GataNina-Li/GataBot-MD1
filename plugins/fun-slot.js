...
let time = global.db.data.users[m.sender].lastwork + 20000
if (new Date - users.lastwork < 20000) throw `𝙑𝙐𝙀𝙇𝙑𝘼 𝙀𝙉 *_${msToTime(time - new Date())}_* 𝙋𝘼𝙍𝘼 𝘾𝙊𝙉𝙏𝙄𝙉𝙐𝘼𝙍 𝘼𝙋𝙊𝙎𝙏𝘼𝙉𝘿𝙊\n\n𝘾𝙊𝙈𝙀 𝘽𝘼𝘾𝙆 𝙄𝙉 *_${msToTime(time - new Date())}_* 𝙏𝙊 𝘾𝙊𝙉𝙏𝙄𝙉𝙐𝙀 𝘽𝙀𝙏𝙏𝙄𝙉𝙂`
