...
let fkontak2 = { key: { participant: '0@s.whatsapp.net' }, message: { contactMessage: { displayName: `𝗠𝗘𝗡𝗦𝗔𝗝𝗘 𝗢𝗙𝗜𝗖𝗜𝗔𝗟 ~ 𝗚𝗔𝗧𝗔 𝗗𝗜𝗢𝗦`, vcard: `BEGIN:VCARD\nVERSION:3.0\nN:XL;${author},;;;\nFN:${author},\nitem1.TEL;waid=${m.sender.split('@')[0]}:${m.sender.split('@')[0]}\nitem1.X-ABLabell:Ponsel\nEND:VCARD`, jpegThumbnail: await(await fetch(img14)).buffer(), thumbnail: false, sendEphemeral: true }}}
