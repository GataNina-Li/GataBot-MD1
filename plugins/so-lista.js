...
if (chat.audios && m.text.match(/(Blackpink in your area|blackpink in your area)/gi)) {    
...
if (chat.audios && m.text.match(/(El Toxico)/gi)) {    
let vn = './media/El Toxico.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
    
if (chat.audios && m.text.match(/(Elmo sabe donde vives|Elmo sabe dónde vives)/gi)) {    
let vn = './media/Elmo sabe donde vives.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
    
if (chat.audios && m.text.match(/(En caso de una investigación|En caso de una investigacion)/gi)) {    
...
if (chat.audios && m.text.match(/(Momento equisde|momento equisde)/gi)) {    
let vn = './media/Momento equisde.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
    
if (chat.audios && m.text.match(/(Motivacion|Motivación)/gi)) {    
let vn = './media/Motivacion.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
    
if (chat.audios && m.text.match(/(Relampago|⛈️|🌩️|🌦️)/gi)) {    
...
if (chat.audios && m.text.match(/(Se están riendo de mí|Se estan riendo de mi|Se esta riendo de mi|Se está riendo de mi)/gi)) {    
...
if (chat.audios && m.text.match(/(Su nivel de pendejo|Su nivel de pendeja)/gi)) {    
...
if (chat.audios && m.text.match(/(Te gusta el Pepino|🥒|🍆)/gi)) {    
...
if (chat.audios && m.text.match(/(Traigan le una falda|Traiganle una falda|Niña|Niño)/gi)) {    
...
if (chat.audios && m.text.match(/(antojen|antogen|ya antojaron|ya antogaron|👌👈)/gi)) {    
...
if (chat.audios && m.text.match(/(Bien pensado woody|bien pensado woody|Bien pensado wudy|bien pensado wudy|Bien pensado Woody|bien pensado Woody|Bien pensado woodi|bien pensado woodi)/gi)) {    
let vn = './media/bien-pensado-woody.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
    
if (chat.audios && m.text.match(/(bañate)/gi)) {    
...
if (chat.audios && m.text.match(/(lgante|keloke)/gi)) {    
...
if (chat.audios && m.text.match(/(Enojado|Molesto|Enojada|Molesta)/gi)) {    
let vn = './media/asen.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
    
if (chat.audios && m.text.match(/(Entrada|Entra|Ingresa|Ingresar)/gi)) {    
let vn = './media/entrada-epica-al-chat.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
    
if (chat.audios && m.text.match(/(Esto va ser épico papus|esto va ser épico papus)/gi)) {    
...
if (chat.audios && m.text.match(/(hola|hello)/gi)) {    
...
if (chat.audios && m.text.match(/(Auronplay|Auron)/gi)) {    
let vn = './media/jesucristo.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
    
if (chat.audios && m.text.match(/(La voz de hombre|la voz de hombre|La voz del hombre|la voz del hombre|La voz|la voz)/gi)) {    
...
if (chat.audios && m.text.match(/(Marica tu|cancion1|Marica quien|maricon)/gi)) {    
...
if (chat.audios && m.text.match(/(PIKA|Pikachu|pikachu|PIKACHU)/gi)) {    
...
if (chat.audios && m.text.match(/(senpai|sempai)/gi)) {    
let vn = './media/sempai.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
    
if (chat.audios && m.text.match(/(Cagaste|Miedo|miedo)/gi)) {    
...
if (chat.audios && m.text.match(/(Verdad que te engañe|verdad que te engañe)/gi)) {    
...
if (chat.audios && m.text.match(/(unapregunta)/gi)) {    
