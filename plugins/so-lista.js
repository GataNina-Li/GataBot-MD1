...
if (chat.audios && m.text.match(/(toxic|tóxic)/gi)) {    
...
if (chat.audios && m.text.match(/(investigación|investigacion|fbi|detective|👤|🕵️‍|♀️🕵️‍♂️)/gi)) {    
...
if (chat.audios && m.text.match(/(anonymous|anonimus|anónimo)/gi)) {    
let vn = './media/Me anda buscando anonymous.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
    
if (chat.audios && m.text.match(/(equisde|🤘|🕴️)/gi)) {    
let vn = './media/Momento equisde.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
    
if (chat.audios && m.text.match(/(grupo muerto|Motivacion|Motivación|💥|☘️)/gi)) {    
let vn = './media/Motivacion.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
    
if (chat.audios && m.text.match(/(Muchachos|⛈️|🌩️)/gi)) {    
...
if (chat.audios && m.text.match(/(tite|🥺|😞)/gi)) {    
...
if (chat.audios && m.text.match(/(riendo|🫵)/gi)) {    
...
if (chat.audios && m.text.match(/(Te gusta el Pepino|🥒|🍆|nepe|pinga)/gi)) {    
let vn = './media/Te gusta el Pepino.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
    
if (chat.audios && m.text.match(/(Todo bien|😇|😃|😁|😄|🏂|⛷️|🏋️‍|♂️🏋️‍|👍)/gi)) {    
...
if (chat.audios && m.text.match(/(pervertido|antojen|antogen|😈|👿|👉👌|👌👈)/gi)) {    
...
if (chat.audios && m.text.match(/(baña)/gi)) {    
...
if (chat.audios && m.text.match(/(bueno si|bueno sí)/gi)) {    
...
if (chat.audios && m.text.match(/(Enojad|Molest|🤬|😡|😠|😤)/gi)) {    
...
if (chat.audios && m.text.match(/(épico|epico)/gi)) {    
...
if (chat.audios && m.text.match(/(Fino señores|fino señores|Fino senores|fino senores|🤨|🧐🍷|🧐🍷|🐍|🙊|🙉|🙈)/gi)) {    
...
if (chat.audios && m.text.match(/(Jesucristo|jesucristo|Jesús|jesús|Auronplay|Auron)/gi)) {    
...
if (chat.audios && m.text.match(/(Murió el grupo|Murio el grupo|murio el grupo|murió el grupo)/gi)) {    
...
if (chat.audios && m.text.match(/(noche de paz|🌚|🌕|🌖|🌗|🌘|🌑|🌒|🌓|🌔|🌙|🪐)/gi)) {    
...
if (chat.audios && m.text.match(/(hablame|Habla me|háblame)/gi)) {    
...
if (!chat.isBanned && chat.audios && m.text.match(/(oye|🐔|chiste)/gi)) {
...
if (!chat.isBanned && chat.audios && m.text.match(/(goo|temazo|fuaa temon)/gi)) {
let vn = './media/sonbare14.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

if (!chat.isBanned && chat.audios && m.text.match(/(Vamos|vamo)/gi)) {
let vn = './media/vamo.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

if (!chat.isBanned && chat.audios && m.text.match(/(:V|:v|v:)/gi)) {
