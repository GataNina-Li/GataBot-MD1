...
conn.reply(m.chat, `LA SOLICITUD DE @${tu} PARA QUE SEAS SU PAREJA HA CADUCADO`, m, { contextInfo: { mentionedJid: [user]}})
}else{
global.db.data.users[m.sender].pasangan = user
conn.reply(m.chat, `Felicitaciones, oficialmente están saliendo. @${tu}\n\nQue dure para siempre y siempre sea feliz @${tu} 💓 @${yo} 🥳🥳🥳`,m, { contextInfo: { mentionedJid: [user, tu, yo]}})
}}	
}
