...
case '1':
let __temporizador1 = user.lastmancingeasy + `${user.premium ? 3600000 : 7200000}` //7200000 //2 h lastfishing
...
//if (user.pancing > 0 ) {
//if (user.umpan > 0 ) {
if (new Date - user.lastmancingeasy > `${user.premium ? 3600000 : 7200000}`) {
...
case '3':
let __temporizador3 = user.lastmancingnormal + 7200000
...
if (new Date - user.lastmancingnormal > 7200000) {
if (user.pancing > 2) {
if (user.pancingan > 2) {
if (user.umpan > 79) {
...
case '4':
let __temporizador4 = user.lastmancinghard + 7200000
...
if (new Date - user.lastmancinghard > 7200000) {
if (user.pancing > 3) {
if (user.pancingan > 3) {
if (user.umpan > 149) {
...
case '5':
let __temporizador5 = user.lastmancingextreme + 7200000
...
if (new Date - user.lastmancingextreme > 7200000) {
if (user.pancing > 4) {
if (user.pancingan > 4) {
if (user.umpan > 199) {
