...
case '1':
let __temporizador1 = user.lastmancingeasy + `${user.premium ? 600000 : 1200000}` //7200000 //2 h lastfishing
...
//if (user.pancing > 0 ) {
//if (user.umpan > 0 ) {
if (new Date - user.lastmancingeasy > `${user.premium ? 600000 : 1200000}`) {
