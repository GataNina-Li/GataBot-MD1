...
{title: "🎣 𝙇𝘼𝙂𝙊 𝙏𝘼𝙉𝙂𝘼𝙉𝙄𝘾𝘼", rowId: usedPrefix + command + ' easy', description: `Atrevete a pescar en la Laguna más diversa del Mundo!!\n`}, 
...
{title: "🎣 𝙀𝙇 𝙈𝘼𝙍 𝘾𝘼𝙎𝙋𝙄𝙊", rowId: usedPrefix + command + ' hard', description: `Un lago tan grande que es probable que abunde muchas especies marinas!!\n`},
