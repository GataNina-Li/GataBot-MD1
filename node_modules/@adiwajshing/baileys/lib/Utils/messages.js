...
exports.downloadMediaMessage = exports.updateMessageWithReceipt = exports.getDevice = exports.extractMessageContent = exports.normalizeMessageContent = exports.getContentType = exports.generateWAMessage = exports.generateWAMessageFromContent = exports.generateWAMessageContent = exports.generateForwardMessageContent = exports.prepareDisappearingMessageSettingContent = exports.prepareWAMessageMedia = void 0;
...
const downloadMediaMessage = async (message, type, options) => {
    ...
    const stream = await _1.downloadContentFromMessage(media, mediaType, options);
    if (type === 'buffer') {
