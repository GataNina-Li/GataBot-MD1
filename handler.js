...
export async function handler(chatUpdate) {
    ...
    @@ -243,47 +175,34 @@ export async function handler(chatUpdate) {
    ...
    @@ -301,38 +220,33 @@ export async function handler(chatUpdate) {
    ...
    @@ -344,74 +258,68 @@ export async function handler(chatUpdate) {
    ...
    @@ -427,94 +335,68 @@ export async function handler(chatUpdate) {
