...
m.limit = false
            ...
            let user = global.db.data.users[m.sender] // TODO: use loop to insert data instead of this
            if (typeof user !== 'object') global.db.data.users[m.sender] = {}
		
            if (user) {
            if (!isNumber(user.exp)) user.exp = 0
            if (!isNumber(user.limit)) user.limit = 20 //Al iniciar, cada usuario tiene esa cantidad de Diamantes
            ...
            if (!isNumber(user.lastmonthly)) user.lastmonthly = 0
                ...
                global.db.data.users[m.sender] = {
                    exp: 0,
                    limit: 20, //Al iniciar, cada usuario tiene esa cantidad de Diamantes
                    lastclaim: 0,
                    registered: false,
                    name: m.name,
                    age: -1,
...
if (xp > 2000) m.reply('Ngecit -_-') // Hehehe
else
m.exp += xp
