...
//handler.js
const smsCont1 = () => {
return `*🔴 𝗖𝗢𝗠𝗔𝗡𝗗𝗢 𝗙𝗔𝗟𝗟𝗔𝗡𝗗𝗢 : 𝗘𝗥𝗥𝗢𝗥 🔴*`}
const smsCont2 = () => {
return `*⚠️ 𝗣𝗟𝗨𝗚𝗜𝗡*`}
const smsCont3 = () => {
return `*⚠️ 𝗨𝗦𝗨𝗔𝗥𝗜𝗢 : 𝗨𝗦𝗘𝗥𝗡𝗔𝗠𝗘*`}
const smsCont4 = () => {
return `*⚠️ 𝗖𝗢𝗠𝗔𝗡𝗗𝗢 : 𝗖𝗢𝗠𝗠𝗔𝗡𝗗*`}
const smsCont5 = () => {
return `*⚠️ 𝗘𝗥𝗥𝗢𝗥*`}
const smsCont6 = () => {
return `*❗ 𝗥𝗘𝗣𝗢𝗥𝗧𝗘 𝗘𝗦𝗧𝗘 𝗠𝗘𝗡𝗦𝗔𝗝𝗘 𝗨𝗦𝗔𝗡𝗗𝗢 𝗘𝗟 𝗖𝗢𝗠𝗔𝗡𝗗𝗢 #reporte 𝗣𝗔𝗥𝗔 𝗦𝗢𝗟𝗨𝗖𝗜𝗢𝗡𝗔𝗥𝗟𝗢*`}
const smsCont7 = () => {
return `*𝙉𝙊 𝙏𝙄𝙀𝙉𝙀 𝘿𝙄𝘼𝙈𝘼𝙉𝙏𝙀𝙎. 💎 𝙋𝙐𝙀𝘿𝙀 𝘾𝙊𝙈𝙋𝙍𝘼𝙍 𝘾𝙊𝙉 𝙀𝙇 𝘾𝙊𝙈𝘼𝙉𝘿𝙊*`}
const smsCont8 = () => {
return ` *𝘿𝙄𝘼𝙈𝘼𝙉𝙏𝙀(𝙎) 💎 𝙐𝙎𝘼𝘿𝙊(𝙎)*`}
const smsCont9 = () => {
return `*𝙉𝙀𝘾𝙀𝙎𝙄𝙏𝘼 𝙀𝙇 𝙉𝙄𝙑𝙀𝙇 ➡️*`}
const smsCont10 = () => {
return `*𝙋𝘼𝙍𝘼 𝙋𝙊𝘿𝙀𝙍 𝙐𝙎𝘼𝙍 𝙀𝙎𝙏𝙀 𝘾𝙊𝙈𝘼𝙉𝘿𝙊. 𝙏𝙐 𝙉𝙄𝙑𝙀𝙇 𝙀𝙎 ➡️*`}
const smsCont11 = () => {
return `*𝘼𝘾𝙏𝙐𝘼𝙇𝙄𝙕𝘼 𝙏𝙐 𝙉𝙄𝙑𝙀𝙇 𝘾𝙊𝙉 𝙀𝙇 𝘾𝙊𝙈𝘼𝙉𝘿𝙊*`}
const smsCont12 = () => {
return `𝙂𝙧𝙪𝙥𝙤 𝙂𝙚𝙣𝙞𝙖𝙡 | 𝘾𝙤𝙤𝙡 𝙂𝙧𝙤𝙪𝙥 😼`}
const smsCont13 = () => {
return `𝙎𝙚 𝙪𝙣𝙞𝙤 🥳`}
const smsCont14 = () => {
return `𝙎𝙚 𝙛𝙪𝙚 𝙪𝙣 𝙍𝙖𝙣𝙙𝙤𝙢 🧐`}
const smsCont15 = () => {
return `𝙃𝙊𝙇𝘼`}
const smsCont16 = () => {
