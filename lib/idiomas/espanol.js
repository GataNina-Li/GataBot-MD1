...
const smsAdveu1 = () => { return `${lenguajeGB['smsAvisoAG']()}*SOLO PUEDE USAR SI ESTA FUNCION ESTA ACTIVADA:*\n`}
const smsAdveu2 = () => { return 'Motivo'}
const smsAdveu3 = () => { return '*RECUERDE ESCRIBIR EL MOTIVO DE LA ADVERTENCIA*\n*'}
...
smsAdveu3, smsAdveu4, smsAdveu5, smsAdveu6, smsAdveu7, smsAdveu8};
