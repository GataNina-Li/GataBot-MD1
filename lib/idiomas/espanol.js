...
global.ag = global.lenguajeGB['smsAviso2']()

const smsAviso3 = () => {
return `╰⊱❕⊱ *INFORMACIÓN* ⊱⊱╮\n\n` }
global.iig = global.lenguajeGB['smsAviso3']()

const smsAviso4 = () => {
return `╰⊱❌⊱ *ERROR* ⊱❌⊱╮\n\n` }
global.fg = global.lenguajeGB['smsAviso4']()

const smsAviso5 = () => {
return `╰⊱❗️⊱ *ACCIÓN MAL USADA* ⊱❗️⊱╮\n\n` }
global.mg = global.lenguajeGB['smsAviso5']()

const smsAviso6 = () => {
return `╰⊱📩⊱ *REPORTE* ⊱📩⊱╮\n\n` }
global.eeg = global.lenguajeGB['smsAviso6']()

const smsAviso7 = () => {
return `╰⊱💚⊱ *ÉXITO* ⊱💚⊱╮\n\n` }
global.eg = global.lenguajeGB['smsAviso7']()
