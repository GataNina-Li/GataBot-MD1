...
### NOTA 
```bash
- ESTE REPOSITORIO PÚBLICA LA VERSIÓN ACTUAL|EDITADO DE GATABOT-MD Y EDITADO POR COLAPSUS DE FUTABUBOT-MD  
...
- REPORTA CUALQUIER FALLO CON EL COMANDO DE REPORTE 
    ...
    @@ -136,5 +131,4 @@ ESCRIBE LOS SIGUIENTES COMANDOS UNO POR UNO:
